    ...
    <section className="w-full bg-[#f7f7f8]">
      <div className="mx-auto flex w-full items-center justify-between px-5 py-12 sm:px-6 md:px-10 md:py-16 lg:px-16 xl:px-20">
        ...
        <div className="w-full max-w-2xl">
          ...
          <h1 className="bg-brand-gradient bg-clip-text text-3xl font-bold leading-tight text-transparent sm:text-4xl md:text-5xl lg:text-6xl">
            Development Stack
          </h1>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 sm:mt-8">
            <button className="cursor-pointer rounded-md bg-brand-gradient px-4 py-3 text-xs font-semibold text-white shadow-sm transition hover:opacity-90 sm:px-5">
