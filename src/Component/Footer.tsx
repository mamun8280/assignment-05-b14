...
const Footer = () => {
  return (
    <footer className="w-full border-t border-gray-100 bg-white py-12 text-sm font-sans text-slate-600">
      ...
      <div className="w-full px-6 lg:px-12">
        ...
        {/* Bottom */}
        <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-100 pt-6 text-xs text-slate-400 sm:flex-row">
